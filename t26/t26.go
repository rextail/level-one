...
//    можно использовать utf8.RuneCountInString вместо len при создании мапы,
//    пусть она лишний раз пройдется по строке,
//    но зато можно будет больше не бояться партия 中国 делать большой пустой карта
